...
describe.skip('AC-9 [P2] Anvil-backed settlement tx well-formedness (opt-in, SDK E2E infra required)', () => {
  it('AC-9 — buildSettlementTx bytes accepted by anvilClient.call (eth_call or eth_estimateGas)', async (ctx) => {
