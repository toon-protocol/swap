...
export default defineConfig({
  ...
  // import the pure key-derivation (`deriveSwapNodeKeys`) via `@toon-protocol/swap/wallet`
  // WITHOUT pulling in the server barrel (startSwapNode/hono/sdk/connector). It only
